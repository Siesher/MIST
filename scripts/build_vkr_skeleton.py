...
STRUCTURE = [
    ...
    ("H1", "Глава 1. Аналитический обзор", "[Вступление главы — общая постановка обзора]"),
    (
        "H2",
    ...
    (
        ...
        "[Вступление главы — переход от обзора к проектированию]",
    ),
    (
        "H2",
    ...
    (
        "H2",
        "2.8. Агентский tool-loop и педагогическая граница",
        "[Tool-loop, инструменты SKI/Forge/web, mermaid/plotly визуализация — 3-4 стр.] [Рис.: sequence tool-loop]",
    ),
    ("H2", "Выводы по главе 2", "[Спроектированная архитектура удовлетворяет требованиям]"),
    ("H1", "Глава 3. Реализация", "[Вступление главы — переход от проектирования к коду]"),
    (
        "H2",
    ...
    (
        "H2",
        "3.10. Inference-стэк: llama-swap + llama.cpp turbo3",
        "[llama-swap multi-model routing + llama.cpp turbo3 KV + --jinja tool-templates + OpenAICompatLLMClient — 3 стр.]",
    ),
    ("H2", "Выводы по главе 3", "[Система полностью реализована]"),
    ("H1", "Глава 4. Экспериментальное исследование", "[Вступление главы — постановка экзамена]"),
    ...
    (
        "H1",
        "Приложение Е. Обоснование выбора технологического стека",
        "[Сравнительный анализ альтернатив для 8 ключевых выборов — LLM, RL, inference, frontend, backend, vector DB, curriculum, search.]",
    ),
    (
        "H1",
        "Приложение Ж. Формулы функций потерь и сводные гиперпараметры",
        "[Формулы PPO/GRPO/GSPO/DPO/KTO/LoRA + сводная таблица гиперпараметров 4 стадий обучения.]",
    ),
]
...
SECTION_IDS = {
    ...
    "Глава 1. Аналитический обзор": "01-0_intro",
    "Глава 2. Проектирование системы": "02-0_intro",
    "Глава 3. Реализация": "03-0_intro",
    "Глава 4. Экспериментальное исследование": "04-0_intro",
    ...
    "2.8. Агентский tool-loop и педагогическая граница": "02-8_tools_viz",
    ...
    "3.10. Inference-стэк: llama-swap + llama.cpp turbo3": "03-10_inference_stack",
    ...
    "Приложение Е. Обоснование выбора технологического стека": "E_choice_justification",
    "Приложение Ж. Формулы функций потерь и сводные гиперпараметры": "Zh_formulas_hyperparams",
}
