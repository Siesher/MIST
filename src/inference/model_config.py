...
MODEL_CONFIGS = {
    ...
    "qwen3.5-9b-turbo": ModelConfiguration(
        ...
        display_name="Qwen3.5-9B + TurboQuant (HF, 4-bit, long context)",
        backend="huggingface",
        hf_model_path="Qwen/Qwen3.5-9B-Instruct",
        gpu_layers=99,
        context_length=32768,
        estimated_vram_gb=5.5,
        estimated_ram_gb=2.0,
        ...
        repetition_penalty=1.0,
        is_moe=False,
        # TurboQuant: 3-bit keys (Q_prod) + 3-bit values (Q_mse)
        # KV cache compressed ~5x → 64K context fits on RTX 2080 8GB
    ...
    "qwen3.5-9b-turbo-2.5bit": ModelConfiguration(
        ...
        display_name="Qwen3.5-9B + TurboQuant 2.5-bit (max compression)",
        backend="huggingface",
        hf_model_path="Qwen/Qwen3.5-9B-Instruct",
        gpu_layers=99,
        ...
        repetition_penalty=1.0,
        is_moe=False,
        # TurboQuant 2.5-bit effective (paper Section 4.3):
        # 32 outlier channels at 3 bits + 96 regular at 2 bits
        turbo_quant_enabled=True,
